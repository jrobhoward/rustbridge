...
public void plugin___fullLifecycle___completesSuccessfully() {
...
class PluginIntegrationTest {
    @Test
    public void testOne() { ... }  // 60s timeout

    @Test
    public void testTwo() { ... }  // 60s timeout
}
```
...
class GlobalStateTest {
    @Test
    public void test___modifiesGlobalState___succeeds() { ... }
}
```
...
9. **Always use timeouts**: Integration tests must have explicit timeouts to prevent hangs

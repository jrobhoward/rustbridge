...
RustBridge supports five host languages (C#, Java, Go, Python, Erlang) with two transport options (JSON and binary). This document provides benchmark data to help you make informed decisions, but **don't let raw numbers drive premature optimization**.

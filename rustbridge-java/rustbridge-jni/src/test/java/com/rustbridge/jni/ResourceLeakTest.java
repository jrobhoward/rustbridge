...
/**
 * Test for resource leak detection in plugin lifecycle (JNI implementation).
...
class ResourceLeakTest {
    ...
    @Test
    @DisplayName("Plugin resources are released on close (JNI)")
    ...
    @Test
    @DisplayName("Sequential load/close cycles don't leak resources (JNI)")
    ...
    @Test
    @DisplayName("Plugin objects are GC-eligible after close (JNI)")
    ...
    @Test
    @DisplayName("Multiple plugins close cleanly (JNI)")
    ...
    @Test
    @DisplayName("Plugin state is correct after use and close (JNI)")
    ...
    @Test
    @DisplayName("Large payload cycles don't leak memory (JNI)")
    ...
    @Test
    @DisplayName("Plugin resources survive concurrent access before close (JNI)")
